...
class OrderPickupExport implements FromCollection,WithProperties,ShouldAutoSize,WithStrictNullComparison,WithColumnWidths,WithStyles,WithTitle
{
    protected $param;
    ...
    */
    public function collection()
    {
        ...
        if($orders){
            ...
            foreach ($orders as $order) {
                ...
                $data[$x+3] = ['訂單日期:'.substr($order->created_at,0,10),'','','','','','物流:'.$order->shippingMethod->name];
    ...
    public function properties(): array
    {
        return [
            ...
            'title'          => 'iCarry後台管理-撿貨單資料匯出',
            'description'    => 'iCarry後台管理-撿貨單資料匯出',
            'subject'        => 'iCarry後台管理-撿貨單資料匯出',
            'keywords'       => '',
            'category'       => '',
            'manager'        => 'iCarry系統管理員',
