...
class OrderShippingSFWarehousingSheet implements FromCollection,WithStrictNullComparison,WithStyles,WithTitle,WithHeadings,ShouldAutoSize,WithColumnWidths
{
                    ...
                    if($item->model_type == 3){ //組合商品需要另外抓item資料
                        ...
                        foreach($packageItems as $packItem){
                            ...
                            $data[] = [
                                ...
                                $quantity,
                                '',
                                '預計日期: '.date("Y/m/d", strtotime('tomorrow')),
                            ];
                            $c++;
                        }
                    }else{
