...
use App\Http\Requests\Admin\SubmenusRequest;
...
class SubMenusController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.submenus.show',$subMenu->id);
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.menus.submenu_show',compact('mainMenu','subMenu','menuCode'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.menus.submenu_show',compact('mainMenu','menuCode'));
    }
