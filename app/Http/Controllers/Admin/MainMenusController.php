...
use App\Http\Requests\Admin\MainmenusRequest;
...
class MainMenusController extends Controller
{
    ...
    {
        $menuCode = 'M1S2';
        $mainMenus = MainmenuDB::orderBy('type','asc')->orderBy('sort','asc')->get();
        $type1Count = 0;
        $type2Count = 0;
        ...
        return view('admin.menus.mainmenu_index',compact('mainMenus','menuCode','type1Count','type2Count'));
    }
    ...
    {
        $menuCode = 'M1S2';
        return view('admin.menus.mainmenu_show',compact('menuCode'));
    }
    ...
    public function store(MainmenusRequest $request)
    {
        ...
        return view('admin.menus.mainmenu_show',compact('mainMenu'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.menus.mainmenu_show',compact('mainMenu','menuCode'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.menus.submenu_index',compact('subMenus'));
    }
    ...
    */
    ...
    public function submenu($id)
    {
        ...
        return view('admin.menus.submenu_index',compact('subMenus','menuCode'));
    }
}
