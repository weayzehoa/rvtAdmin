...
<div class="content-wrapper">
    <div class="content-header">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-6">
                    <h1 class="m-0 text-dark"><b>分類策展</b><small> ({{ isset($curation) ? '修改' : '新增' }})</small></h1>
                </div>
                <div class="col-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">後台管理系統</a></li>
                        <li class="breadcrumb-item active"><a href="{{ url('categorycurations') }}">分類策展</a></li>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    @if(isset($curation))
                    <form id="myform" action="{{ route('admin.categorycurations.update', $curation->id) }}" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="_method" value="PATCH">
                    @else
                    <form id="myform" action="{{ route('admin.categorycurations.store') }}" method="POST" enctype="multipart/form-data">
                    @endif
                            ...
                            <div class="form-group col-12">
                                <div class="row">
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <div>
                                            ...
                                            <div class="icheck-primary d-inline">
                                                <input type="radio" id="type_{{ $key }}" name="type" value="{{ $key }}" {{ isset($curation) && $curation->type == $key ? 'checked' : ($key == 'product' ? 'checked' : '')}}>
                                                <label for="type_{{ $key }}" class="mr-2">{{ $value }}</label>
                                            </div>
                                            @endforeach
                                        </div>
                                        <span class="text-danger text-bold text-sm">目前僅有[商品]版型適用於前台搜尋頁面。其餘版型皆無作用。</span>
                                    </div>
                                        ...
                                        <div class="col-10">
                                            <div class="row">
                                                <div class="form-group col-2">
                                                    ...
                                                    <div class="input-group">
                                                        <select class="form-control" name="show_background_type">
                                                            ...
                                                            <option value="image" {{ isset($curation) ? $curation->show_background_type == 'image' ? 'selected' : '' : '' }}>背景圖片</option>
                                                ...
                                                <div class="form-group col-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control {{ $errors->has('background_color') ? ' is-invalid' : '' }}" name="background_color" value="{{ $curation->background_color ?? '' }}" placeholder="顏色代碼，EX: #FFCC11F2">
                                                ...
                                                <div class="form-group col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control {{ $errors->has('background_css') ? ' is-invalid' : '' }}" name="background_css" value="{{ $curation->background_css ?? '' }}" placeholder="請輸入CSS代碼，例如：background-color: #00ffff;">
                                                    </div>
                                    ...
                                    <div id="layoutcolumns" class="form-group col-4" style="display: none">
                                        <label for="columns">策展布局設定(欄數):</label>
                                        <div id="columns">
                                            @if(isset($curation))
                                            @if($curation->type != 'block' && $curation->type != 'nowordblock')
                                            @for($i = 2; $i <= 6; $i++)
                                            <div class="icheck-success d-inline">
                                                <input type="radio" id="columns{{ $i }}" name="columns" value="{{ $i }}" {{ isset($curation) && $curation->columns == $i ? 'checked' : ($i==1 ? 'checked' : '')}}>
                                    ...
                                    <div id="layoutrows" class="form-group col-3" style="display: none">
                                        ...
                                        <div>
                                            @for($i = 1; $i <= 2; $i++)
                                            <div class="icheck-success d-inline">
                                                <input type="radio" id="rows{{ $i }}" name="rows" value="{{ $i }}" {{ isset($curation) && $curation->rows == $i ? 'checked' : ($i==1 ? 'checked' : '')}}>
                                    ...
                                    <div class="form-group col-12">
                                        @if(empty($curation))
                                        <h3 class="text-danger">新增時，請先設定好基本資料並儲存後，才能設定版型及語言資料</h3>
                                        @else
                                        <h3 class="text-danger">變更版型時，請記得按修改儲存，前台才會顯示正確的版型</h3>
                                        @endif
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-10 row">
                                                            ...
                                                            <div class="form-group col-3">
                                                                ...
                                                                <div>
                                                                    <div class="icheck-success d-inline">
                                                                        <input type="radio" id="image_text_position_inside" name="text_position" value="inside">
                                                                        <label for="image_text_position_inside" class="mr-2">內部</label>
                                                                    </div>
                                                                    <div class="icheck-success d-inline">
                                                                        <input type="radio" id="image_text_position_bottom" name="text_position" value="bottom" checked>
                                                                        <label for="image_text_position_bottom" class="mr-2">底部</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-group col-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-3">
                                                        <div class="text-center">
                                                            @if($product->image)
                                                            <a href="{{ env('AWS_FILE_URL').$product->image }}" data-toggle="lightbox" data-title="{{ $product->name .' 商品圖片 ' }}" data-gallery="gallery" data-max-width="1440">
                                                                <img height="200" class="product_image_{{ $product->id }}" src="{{ env('AWS_FILE_URL').$product->image }}" alt="">
                                                            </a>
