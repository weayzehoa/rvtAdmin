...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"><b>分類策展</b></h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-5">
                                    ...
                                    <a href="{{ route('admin.categorycurations.create') }}" class="btn btn-sm btn-primary"><i class="fas fa-plus mr-1"></i>新增</a>
                                    @endif
                                    @if(in_array($menuCode.'S',explode(',',Auth::user()->power)))
                                    <button class="sort-btn btn btn-sm btn-success" value="sort"><i class="fas fa-sort-numeric-down mr-1"></i><span id="sort_text">手動排序</span></button>
                                    @endif
                                </div>
                                <div class="col-7">
                                    <div class=" float-right">
                                        <div class="input-group input-group-sm align-middle align-items-middle">
                                            ...
                                            <form action="{{ url('categorycurations') }}" method="GET" class="form-inline" role="search">
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-hover table-sm">
                                ...
                                <form id="myform" action="{{ route('admin.categorycurations.sort') }}" method="POST" class="form-inline" role="search">
                                    @csrf
                                </form>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-left align-middle">
                                            <a href="{{ route('admin.categorycurations.show',$curation->id) }}">{{ $curation->main_title }}</a>
                                        </td>
                                        ...
                                        <td class="text-center align-middle">
                                            @if($loop->iteration != 1)
                                            <a href="{{ url('categorycurations/sortup/' . $curation->id) }}" class="text-navy">
                                                <i class="fas fa-arrow-alt-circle-up text-lg"></i>
                                            </a>
                                            @endif
                                            @if($loop->iteration != count($curations))
                                            <a href="{{ url('categorycurations/sortdown/' . $curation->id) }}" class="text-navy">
                                        ...
                                        @if(in_array($menuCode.'O',explode(',',Auth::user()->power)))
                                        <td class="text-center align-middle">
                                            <form action="{{ url('categorycurations/active/' . $curation->id) }}" method="POST">
                                                @csrf
