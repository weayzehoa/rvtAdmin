            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ url('mails') }}">信件管理</a></li>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">發送信件隊列測試</h3>
                        </div>
...
@section('JsValidator')
{!! JsValidator::formRequest('App\Http\Requests\Admin\SendMailRequest', '#myform'); !!}
{!! JsValidator::formRequest('App\Http\Requests\Admin\SendNoteRequest', '#sendnoteform'); !!}
{!! JsValidator::formRequest('App\Http\Requests\Admin\SendQueuesRequest', '#sendqueuesform'); !!}
@endsection
...
<script>
    (function($) {
        ...
        var sendQueuesEditor = CKEDITOR.replace( 'sendqueues');
        sendQueuesEditor.on( 'required', function( sendQueuesEvt ) {
            sendQueuesEditor.showNotification( '請輸入資料再按儲存.', 'warning' );
            sendQueuesEvt.cancel();
        } );
    })(jQuery);
</script>
@endsection
