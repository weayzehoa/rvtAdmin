            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">中繼管理系統</a></li>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="product_data_add" style="display:none">
                                <form class="ProductForm" action="{{ route('admin.ipSettings.store') }}" method="POST">
                                    @csrf
                                    <div class="card-body">
                                        <div class="row">
                            ...
                            <table class="table table-hover table-sm">
                                ...
                                <tbody>
                                    @foreach ($ips as $ip)
                                    <tr>
                                        <form action="{{ route('admin.ipSettings.update', $ip->id) }}" method="POST">
                                            @csrf
                                        ...
                                        <td class="text-center align-middle">
                                            @if(in_array($menuCode.'D',explode(',',Auth::user()->power)))
                                            @if(!in_array($ip->ip,$disable))
                                            <form action="{{ route('admin.ipSettings.destroy', $ip->id) }}" method="POST">
                                                @csrf
