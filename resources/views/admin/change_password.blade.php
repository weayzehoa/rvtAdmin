...
<body class="hold-transition login-page bg-navy" style="background-image: url({{ asset('img/bg.jpg') }});">
    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <form id="myform" action="{{ route('admin.passwordChange.submit') }}" method="post" autocomplete="off">
                    @csrf
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Admin\PasswordChangeRequest', '#myform'); !!}
</body>
