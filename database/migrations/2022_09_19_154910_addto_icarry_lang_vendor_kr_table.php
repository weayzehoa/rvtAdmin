...
class AddtoIcarryLangVendorKrTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (env('DB_MIGRATE_ADD_TO_ICARRY_LANG_VENDOR_KR_TABLE')) {
            Schema::connection('icarryLang')->table('vendor_kr', function (Blueprint $table) {
