...
class AddtoIcarryLangVendorThTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (env('DB_MIGRATE_ADD_TO_ICARRY_LANG_VENDOR_TH_TABLE')) {
            Schema::connection('icarryLang')->table('vendor_th', function (Blueprint $table) {
